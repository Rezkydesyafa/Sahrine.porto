...
export default function Home() {
  ...
  const handleSendEmail = (e) => {
    ...
    const subject = encodeURIComponent(
      `Pesan dari ${emailForm.name || 'Pengunjung Website'}`,
    );
      ...
      <div className='page-wrap'>
        <main>
          ...
          <section className='hero' id='home'>
            ...
            >
              <img src={PROFILE_DATA.avatarSrc} alt={PROFILE_DATA.name} />
            </motion.div>
          </section>
          ...
          >
            <div className='section-stack'>
              <h2>Education</h2>
              <motion.div
                className='resume-list education-list'
                variants={staggerContainer}
              >
          ...
          >
            <div className='showcase-heading'>
              ...
              <p>
                Program pembelajaran dan pencapaian yang memperkuat fondasi
                data, AI, pemrograman, serta inovasi digital.
              </p>
            </div>
          ...
          >
            ...
            <p>
              ...
              <a href={`mailto:${PROFILE_DATA.email}`}>
                Kirim email kepada saya
              </a>{' '}
              atau terhubung melalui{' '}
              <a href={PROFILE_DATA.linkedin} target='_blank' rel='noreferrer'>
                LinkedIn
              </a>
              .
            </p>
  ...
  switch (skillName) {
    ...
    case 'JavaScript':
      return (
        <svg viewBox='0 0 24 24'>
          ...
          />
          <path
            d='M11 16.5v-5m7 5c-1 0-2-.5-2-2m2-3v5'
            stroke='#111'
            strokeWidth='2'
            strokeLinecap='round'
          />
    ...
    case 'Problem Solving':
      return (
        <svg viewBox='0 0 24 24'>
          <path
            d='M9 18h6m-4 3h2M12 2a7 7 0 0 0-7 7c0 2.38 1.19 4.47 3 5.74V17a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1v-2.26c1.81-1.27 3-3.36 3-5.74a7 7 0 0 0-7-7z'
            stroke='currentColor'
            strokeWidth='1.8'
            fill='none'
          />
...
function RenderProjectGraphic({ projectId }) {
  switch (projectId) {
    case 'simrs':
      return (
        <img
          src='/portfolio/images/simrs.jpg'
          alt='SIMRS Dashboard'
          style={{
            width: '100%',
            height: '100%',
    ...
    case 'mentorize':
      return (
        <img
          src='/portfolio/images/mentorize.jpg'
          alt='MENTORIZE'
          style={{
            width: '100%',
            height: '100%',
    ...
    case 'sampahin':
      return (
        <img
          src='/portfolio/images/sampahin.jpg'
          alt='SampahIn'
          style={{
            width: '100%',
            height: '100%',
    ...
    case 'leeboba':
      return (
        <img
          src='/portfolio/images/leeboba.jpg'
          alt='Lee Boba'
          style={{
            width: '100%',
            height: '100%',
    ...
    case 'jendeladunia':
      return (
        <img
          src='/portfolio/images/jendeladunia.jpg'
          alt='Jendela Dunia'
          style={{
            width: '100%',
            height: '100%',
